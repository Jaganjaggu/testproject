            ...
            <div>
                            ...
                            <div className="tab-content" id="pills-tabContent">
                                ...
                                <div className="section-body mb-3">
                                    ...
                                    {/* <!-- Media --> */}
                                    <div className="media p-3"> <img src="images/author1.jpg" alt="John Doe" className="mr-3 rounded-circle" style={{width:'86px'}}/>
                                        ...
                                        <div className="article-body">
                                            <h5>I Totally agree <a href=""><img src="images/dlt11.png" className="float-right ml-2"/></a><a className="btn btn-outline-primary btn-round font-12 float-right create-post blue-create-post"> &nbsp; <b>Create Post</b> </a> </h5>
                                            ...
                                            <div className="popup-images d-flex"> <a href="#" className="m-1"> <img src="images/widget-1.jpg" className="brd-rounded5"/> </a> <a href="#" className="m-1"> <img src="images/widget-2.jpg" className="brd-rounded5"/> </a> <a href="#" className="m-1"> <img src="images/widget-3.jpg" className="brd-rounded5"/> </a> <a href="#" className="m-1"> <img src="images/widget-4.jpg" className="brd-rounded5"/> </a> </div>
                                        </div>
                                        </div>
                                    </div>
                                    {/* <!--//--> */}
                                    ...
                                    <div className="comment p-3 mt-2 mb-3">
                                        ...
                                        <li> <a href="#"> <img src="images/icon-comment.png"/> <sup><span className="locked alert-bg"><img src="images/lock-icon.png"/></span></sup> </a> <span className="total">32</span> </li>
                            ...
                            {/* <!--  tab Saved --> */}
                                ...
                                <div className="section-body mb-3">
                                    ...
                                    <div className="media p-3"> <img src="images/author1.jpg" alt="John Doe" className="mr-3 rounded-circle" style={{width:'86px'}}/>
                                        ...
                                        <div className="article-body">
                                        <h5>I Totally agree <a href=""><img src="images/dlt11.png" className="float-right ml-2"/></a> <a><img src="images/saved.png" className="float-right ml-2"/> &nbsp;</a> </h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation <a className="font-pink" href="#"><small><u>more...</u></small></a></p>
                                        <p className="author">Posted by <a href="#">James_007 </a>2 hours ago</p>
                                        {/* <!----> */}
                                        <div className="tags mb-4"> <a href="#" className="btn btn-tags selected mr-1"> #COLLEGE </a> <a href="#" className="btn btn-tags mr-1"> #EDUCATION </a> <a href="#" className="btn btn-tags mr-1"> #SCHOOL </a><a href="#" className="btn btn-language float-right"> MALAYALAM </a> </div>
                            ...
                            <div className="section-body mb-3">
                                ...
                                <div className="media p-3"> <img src="images/author1.jpg" alt="John Doe" className="mr-3 rounded-circle" style={{width:'86px'}}/>
                                    ...
                                    <div className="article-body">
                                        <h5>I Totally agree <a href=""><img src="images/dlt11.png" className="float-right ml-2"/></a> <a href=""><img src="images/saved.png" className="float-right ml-2"/> </a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation <a className="font-pink" href="#"><u>more...</u></a></p>
                                        <p className="author">Posted by <a href="#">James_007 </a>2 hours ago</p>
                                        {/* <!----> */}
